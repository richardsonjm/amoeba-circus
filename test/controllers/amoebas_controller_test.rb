...
class AmoebasControllerTest < ActionController::TestCase
  ...
  test "should create amoeba" do
    assert_difference('Amoeba.count') do
      post :create, amoeba: { generation: @amoeba.generation, name: @amoeba.name, talent_id: @amoeba.talent_id }
    end
  ...
  test "should update amoeba" do
    patch :update, id: @amoeba, amoeba: { generation: @amoeba.generation, name: @amoeba.name, talent_id: @amoeba.talent_id }
    assert_redirected_to amoeba_path(assigns(:amoeba))
  end
